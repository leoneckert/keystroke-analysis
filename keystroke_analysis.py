...
def Main():
	...
	allKeyStrokesFromScript = ["a","s","d","f","h","g","z","x","c","v","`","b","q","w","e","r","y","t","1","2","3","4","6","5","=", "9","7","-","8","0","]","o","u","[","i","p","l","j","'","k",";","\\",",","/","n","m",".","`","[enter]","[tab]","[space]","[backspace]","[esc]","[cmd]","[cmd]","[shift]", "[caps]","[alt]","[ctrl]","[shift]","[alt]","[left]","[right]","[down]","[up]","[unknown]"]
